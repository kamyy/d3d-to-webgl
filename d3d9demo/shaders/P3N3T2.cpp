...
#ifdef _DEBUG
	#include "P3N3T2_VS_D.h"
	#include "P3N3T2_PS_D.h"
#else
	#include "P3N3T2_VS_R.h"
	#include "P3N3T2_PS_R.h"
#endif
#include "../Shader.h"

namespace eve {
	P3N3T2::P3N3T2() : Shader(getName(), VtxMgr::DI_P3N3T2, g_vs20_main, g_ps20_main) {}

	void P3N3T2::setVSConstData(const Material* mat) const {
	...
	void P3N3T2::setPSConstData(const Material* mat) const {
		...
		setPSConstReg(4, 1, up * !s_frame->getWorldMatrix()); // world up in model space
	}
}

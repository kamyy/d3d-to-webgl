...
function RenderPanel(props) {
  const { sceneState, curSceneId, onToggleWirefrm, onToggleNormals } = props
      ...
      <div>
        <span id="wirefrm-choice" className="CanvasPanel">
          <input
            id={id0}
            type="checkbox"
            checked={sceneState.drawWirefrm}
            onChange={() => onToggleWirefrm(curSceneId)}
            className="Checkbox"
          />
        ...
        <span id="normals-choice" className="CanvasPanel">
          <input
            id={id1}
            type="checkbox"
            checked={sceneState.drawNormals}
            onChange={() => onToggleNormals(curSceneId)}
            className="Checkbox"
          />

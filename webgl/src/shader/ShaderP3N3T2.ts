...
const vertexAttributeDescsP3N3T2: VertexAttributeDesc[] = [
  { attrib: "a_pos", length: 3, stride: 32, offset: 0 },
  { attrib: "a_nrm", length: 3, stride: 32, offset: 12 },
  { attrib: "a_tex", length: 2, stride: 32, offset: 24 },
]

...
function LightsPanel(props) {
  const { sceneState, curSceneId, onChangeLightSource, onChangeR, onChangeG, onChangeB } = props
  ...
  if (sceneState) {
    ...
    switch (sceneState.currentLS) {
      case 'Omni Directional':
        ;[r, g, b] = sceneState.omniDirLS
        break
      case 'Lower Ambient':
        ;[r, g, b] = sceneState.lowerAmbientLS
        break
      case 'Upper Ambient':
        ;[r, g, b] = sceneState.upperAmbientLS
        break
      default:
        r = g = b = 0
        break
      ...
      <div id="LightPanel" className="CanvasPanel">
        <fieldset className="Fieldset">
          ...
          <select
            ...
            value={sceneState.currentLS}
            onChange={(event) => onChangeLightSource(curSceneId, event.target.value)}
          >
